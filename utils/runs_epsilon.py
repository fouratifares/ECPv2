...
from utils.fig_generator import plot_epsilon
...
def runs_epsilon(
    ...
    for optimizer in optimizers:
        ...
        for i in range(n_run):
            ...
            if method == "ECP" or method == "AdaLIPO" or method == "AdaLIPO_P":
                points, values, epsilons = optimizer[0](f, n=n_eval)
                ...
                points, values = optimizer[0](f, n=n_eval)
        ...
        # if method == "ECP" or method == "AdaLIPO" or method == "AdaLIPO_P":
            ...
            list_of_epsilon.append(epsilons_avg)
    ...
    print(len(list_of_epsilon))
    plot_epsilon(list_of_epsilon[0], list_of_epsilon[1], list_of_epsilon[2], title="colville")

    if method == "ECP" or method == "AdaLIPO" or method == "AdaLIPO_P":
        return points, values, epsilons
    else:
